            ...
            <div className="padding innerWidth flexCenter c-container">
                ...
                <div className="flexColStart c-left">
                    ...
                    <span className="secondaryText">We always ready to help by providing the best service for you.
                        <br/>
                        We beleive a good place to take vacation make your life better
                    </span>
                            ...
                            <div className="flexColCenter mode">
                                <div className="flexStart">
                                    ...
                                    <div className="flexColStart detail">
                                        ...
                                        <span className="secondaryText">091 256 4865</span>
                                    </div>
                                </div>
                            ...
                            <div className="flexColCenter mode">
                                <div className="flexStart">
                                    ...
                                    <div className="flexColStart detail">
                                        ...
                                        <span className="secondaryText">075 256 4865</span>
                                    </div>
                                </div>
